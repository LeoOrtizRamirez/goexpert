...
foreach ($row as $value) {
    ...
    $topmbrsopt .= "<option value='{$mbrstr['mpid']}'{$isselected}>{$mbrstr['id']}.{$mbrstr['mpid']}. {$mbrstr['firstname']} {$mbrstr['lastname']} ({$mbrstr['username']} - " . maskmail($mbrstr['email']) . "){$isusercyc}</option>";
}
