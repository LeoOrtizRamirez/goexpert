...
$LANG['g_havequestion'] = "¿Tiene alguna pregunta?";
...
$LANG['g_walletcredit'] = "Crédito de billetera";
$LANG['g_walletdebit'] = "Débito de billetera";
...
$LANG['g_withdrawstatusinfo'] = "Pending: La solicitud se ha enviado pero aún no se ha procesado. Verified: La solicitud ha pasado la verificación. Processing: la solicitud se está procesando. Una vez procesada, los fondos se enviarán a su cuenta.";
...
$LANG['g_websitestatus'] = "Estado del sitio web";
$LANG['g_cycle'] = "Ciclo";
$LANG['g_plan'] = "Plan";
$LANG['g_nosite'] = "No pudimos encontrar ningún sitio web";
$LANG['g_nositenote'] = "Lo sentimos, no podemos encontrar ningún sitio web para usted :(";
$LANG['g_free'] = "Gratis";
$LANG['g_expirationdate'] = "Fecha de caducidad";
$LANG['g_expirywithin'] = "Expiera en";
...
$LANG['a_managemember'] = "Administrar aprendiz";
$LANG['a_findmember'] = "Buscar aprendiz";
$LANG['a_historylist'] = "Historial de transacciones";
$LANG['a_withdrawlist'] = "Retirar solicitud";
$LANG['a_genealogylist'] = "Genealogía";
...
$LANG['a_outplanmark'] = "El plan de pago del aprendiz no es lo mismo que el plan de pago del sistema. Podría suceder cuando la configuración del plan de pago se haya cambiado después de que este miembro se haya registrado.";
$LANG['a_outplanreg'] = "La tarifa de registro del aprendiz no es la misma que la del plan de pago del sistema. Podría suceder cuando la tarifa de registro en la configuración del plan de pago se haya cambiado después de que este miembro se haya registrado.";
$LANG['m_getstarted'] = "Comenzando";
$LANG['m_genealogyview'] = "Genealogía";
$LANG['m_digiload'] = "Descargar";
$LANG['m_digiview'] = "Carreras digitales";
...
$LANG['m_profilepaynote'] = "Configuración de la cuenta de aprendiz";
...
$LANG['disable'] = "Inactivo";
$LANG['enable'] = "Activo";
$LANG['level_depth'] = "Profundidad de nivel";
$LANG['level_width'] = "Tamaño del nivel";
