...
function doipnbox($txmpid, $payamount, $paygate, $txbatch, $redirurl, $ipnreturn = '', $skipamount = 0, $addtoken = '') {
    ...
    if (($trxstr['txamount'] <= $txamount || $skipamount == 1) && get_optionvals($trxstr['txtoken'], 'isapproved') != 1) {
        ...
        if ($update && ($newtrxid > 0 || $existingtxstatus == 0)) {
            ...
            $cmdrlist = (defined('ISCALC_BYMBR')) ? $bpparr[$mbrstr['mppid']]['cmdrlist'] : $bpparr[$mpidref]['cmdrlist'];
            ...
            if ($isrenew == 1) {
                $cmlist = (defined('ISCALC_BYMBR')) ? $bpparr[$mbrstr['mppid']]['cmlistrnew'] : $bpparr[$mpidspr]['cmlistrnew'];
            } else {
                $cmlist = (defined('ISCALC_BYMBR')) ? $bpparr[$mbrstr['mppid']]['cmlist'] : $bpparr[$mpidspr]['cmlist'];
            }
