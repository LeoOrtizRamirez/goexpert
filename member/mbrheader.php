...
<html lang="{$LANG['lang_iso']}">
    ...
    <body>
        <div id="app">
         ...
         <li{$menuactive['digiview']}><a class="nav-link" href="index.php?hal=digiview"><i class="fa fa-server"></i><span>{$LANG['m_digiview']}</span></a></li>
        <li><a class="nav-link" href="#"><i class="fas fa-user-graduate"></i><span>Academia</span></a></li>
         <li{$menuactive['digilibrary']}><a class="nav-link" href="index.php?hal=digilibrary"><i class="fa fa-laptop"></i><span>Biblioteca</span></a></li>
