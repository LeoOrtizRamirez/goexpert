    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                ...
                <a href="index.php"> <img src="<?php echo myvalidate($site_logo); ?>" alt="logo" width="35%"></a>
                </div>
...
INI_HTML;
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label class="form-label">Select membership to register</label>
                                    ...
                                    foreach ($userData as $val) {
                                        ...
                                        $planlist_content .= <<<INI_HTML
                                            <label class="selectgroup-item">
                                                <input type="radio" name="ppid" value="{$val['ppid']}" class="selectgroup-input" required>
...
INI_HTML;
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <input id="firstname" type="text" class="form-control" placeholder="Nombre" name="firstname" value="<?php echo myvalidate($_SESSION['firstname']); ?>" minlength="3" autofocus required>
                                        <div class="invalid-feedback">
                                        Por favor, introduzca su Nombre
                                        </div>
                                    </div>
                                    <div class="form-group col-6">
                                        <input id="lastname" type="text" class="form-control"   placeholder="Apellido" name="lastname" value="<?php echo myvalidate($_SESSION['lastname']); ?>" minlength="3" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <input id="username" type="text" class="form-control"  placeholder="Usuario" name="username" value="<?php echo myvalidate($_SESSION['username']); ?>" minlength="4" maxlength="16" onBlur="checkMember('unex', this.value, '')" required>
                                        <div class="invalid-feedback">
                                        Por favor, introduzca su Usuario
                                        </div>
                                    </div>
                                    <div class="form-group col-6">
                                        <input id="email" type="email" class="form-control" placeholder="Email" name="email" value="<?php echo myvalidate($_SESSION['email']); ?>" minlength="8" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <input id="password" type="password" class="form-control" placeholder="Contraseña" data-indicator="pwindicator" name="password" required>
                                    </div>
                                    <div class="form-group col-6">
                                        <input id="password2" type="password" class="form-control" placeholder="Confirmar Contraseña" name="passwordconfirm">
                                    </div>
                                </div>
                            ...
                            <div class="mt-4 text-muted text-center">
                                <?php echo myvalidate($LANG['g_haveacc']); ?> <a href="login.php">Iniciar Sesión</a><br />
                                <?php echo myvalidate($LANG['g_havequestion']); ?> <a href="contact.php">Contacto con nosotros</a>
                            </div>
                        </div>
                    </form>
                </div>
